...
#样本是以句子为单位的每一个句子是一个样本
#句子由max_words个词，因此可以由max_words* embedding_size的矩阵表示
#这里的logstic回归是对max_words个词语做了均值，在均值上执行了logstic回归
#相当于使用embedding_size长的均值向量代表了一句话
#一句话有max_words个词语,x_data有max_words个词向量，词向量取个均值.代表一句话
